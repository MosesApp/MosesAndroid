 ...
 */
public class HomeGroupRecyclerAdapter extends RecyclerView.Adapter<HomeGroupRecyclerAdapter.GroupViewHolder> {
    private List<Group> mGroups;

    public HomeGroupRecyclerAdapter(List<Group> groups) {
        mGroups = groups;
    }
    ...
    public GroupViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_group_card_item, parent, false);
